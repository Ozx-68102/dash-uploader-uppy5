...
| `size`                              | dict[str, int \| str]               | None              | Size of the Dashboard. Accepts `"width"` and `"height"`. Use int for pixels, or a CSS length string (`"100%"`, `"75px"`, `"50vw"`, `"10rem"`, etc.). Examples: `{"width": 500, "height": 300}`, `{"width": "100%", "height": "75px"}`. |
